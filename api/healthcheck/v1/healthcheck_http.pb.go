...
const OperationHealthCheckHealthCheck = "/healthcheck.v1.HealthCheck/HealthCheck"

type HealthCheckHTTPServer interface {
	// HealthCheck Getting a healthcheck status
	HealthCheck(context.Context, *HealthCheckRequest) (*HealthCheckResponse, error)
}

func RegisterHealthCheckHTTPServer(s *http.Server, srv HealthCheckHTTPServer) {
	r := s.Route("/")
	r.GET("/healthz", _HealthCheck_HealthCheck0_HTTP_Handler(srv))
}
...
func (c *HealthCheckHTTPClientImpl) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...http.CallOption) (*HealthCheckResponse, error) {
